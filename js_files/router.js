...
const handleLocation = async () => { //async 안에서만 await이 사용가능하다  에러핸들링 
...
//async awiat 이란 
//async 키워드는 일반 함수를 비동기 함수로 바꾸어 놓습니다. 이렇게 만든 비동기 함수는 await 키워드를 사용해서, promise가 "정착" 
//상태가 될 때 까지 그 실행을 일시 중지 시킬 수 있습니다. 아래 함수에서, await 키워드는 함수의 실행을 약 1초 간 일시 정지 시킵니다.